    ...
    <main className="min-h-screen bg-zinc-900 text-zinc-100 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-4">
          ...
          <textarea
            className="w-full bg-zinc-800 border border-zinc-700 rounded-md p-3 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500"
            rows={2}
